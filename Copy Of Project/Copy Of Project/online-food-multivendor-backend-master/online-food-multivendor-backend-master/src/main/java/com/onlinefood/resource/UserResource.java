...
public class UserResource {
	...
	public ResponseEntity<UserLoginResponse> login(UserLoginRequest loginRequest) {
		...
		User user = null;
		User loginUser= userService.getUserByEmailid(loginRequest.getEmailId());
		String roleOfUser= loginUser.getRole();
		List<GrantedAuthority> authorities = Arrays.asList(new SimpleGrantedAuthority(roleOfUser));
		...
		user = this.userService.getUserByEmailIdAndRoleAndStatus(loginRequest.getEmailId(), roleOfUser,
				UserStatus.ACTIVE.value());
